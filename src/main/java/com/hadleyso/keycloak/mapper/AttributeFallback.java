...
public class AttributeFallback extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper, OIDCIDTokenMapper, UserInfoTokenMapper, TokenIntrospectionTokenMapper {
    ...
    public static final String PROVIDER_ID = "hs-upn-attribute-fallback";
    ...
    protected void setClaim(IDToken token, ProtocolMapperModel mappingModel, UserSessionModel userSession) {
        ...
        if (userAttributeValue == null || userAttributeValue.isEmpty()) {
            userAttributeValue = user.getFirstAttribute(mappingModel.getConfig().getOrDefault("FALLBACK_ATTRIBUTE", "FALLBACK_ATTRIBUTE"));
        }
